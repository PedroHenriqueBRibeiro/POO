...
Compromisso* aula_criar(int id, Data data, Hora hora, int duracao_minutos,
    ...
    strncpy(aula->dados_aula.nome_disciplina, nome_disciplina, MAX_STRING - 1);
    aula->dados_aula.nome_disciplina[MAX_STRING - 1] = '\0';
    aula->dados_aula.nivel = nivel;
