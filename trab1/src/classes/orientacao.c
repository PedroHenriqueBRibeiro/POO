...
Compromisso* orientacao_criar(int id, Data data, Hora hora, int duracao_minutos, bool adiavel, const char* nome_orientado, Nivel nivel, Data data_defesa, Hora hora_defesa, int grau_prioridade) {
    ...
    strncpy(orientacao->dados_especificos.dados_orientacao.nome_orientado, nome_orientado, MAX_STRING - 1);
    orientacao->dados_especificos.dados_orientacao.nome_orientado[MAX_STRING - 1] = '\0';
    orientacao->dados_especificos.dados_orientacao.nivel = nivel;
    orientacao->dados_especificos.dados_orientacao.data_defesa = data_defesa;
    orientacao->dados_especificos.dados_orientacao.hora_defesa = hora_defesa;
...
void orientacao_imprimir_completo(Compromisso* orientacao) {
    ...
    switch (orientacao->dados_especificos.dados_orientacao.nivel) {
    ...
    imprimir_data(orientacao->dados_especificos.dados_orientacao.data_defesa);
    printf(" ");
    imprimir_hora(orientacao->dados_especificos.dados_orientacao.hora_defesa);
    printf("\n");
}